...
for country, df in countries_to_test_df.items():
    ...
    if not dups.empty:
        ...
        countries_wihout_dups.append(country)
...
logger.info(f"countries without first level: {len(countries_wihout_dups)} \n{countries_wihout_dups}")
